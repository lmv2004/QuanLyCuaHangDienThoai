...
public class EditKh extends javax.swing.JFrame {
     ...
     */
    private KhachHangDTO khachHangDTO; // Khai báo biến khachHangDTO

    // Các phương thức getter và setter cho biến khachHangDTO
    ...
    public EditKh(KhachHangDTO khachHangDTO) {
    // Xử lý logic để hiển thị thông tin khách hàng trong giao diện cập nhật
     initComponents();
    this.khachHangDTO = khachHangDTO;
    // Đặt giá trị cho các trường văn bản và trường ngày tháng từ đối tượng khachHangDTO
    jTextField1.setText(khachHangDTO.getTenKhachHang());
    jTextField2.setText(khachHangDTO.getDiaChi());
    jTextField4.setText(khachHangDTO.getSDT());
    jDateChooser1.setDate(khachHangDTO.getNgayThamGia());
}    
    /**
    ...
    int maKhachHang = khachHangDTO.getMaKhachHang();
    
    // Khởi tạo đối tượng KhachHangDTO mới với thông tin đã cập nhật
    KhachHangDTO kh = new KhachHangDTO(maKhachHang, name, diachi, sdt, 1, ngaythamgia);
    
    // Cập nhật thông tin khách hàng trong CSDL
    new KhachHangBUS().edit(kh);
    
    // Hiển thị thông báo cập nhật thành công
    JOptionPane.showMessageDialog(this, "Bạn đã cập nhật thành công!");
    
    // Đóng cửa sổ chỉnh sửa thông tin khách hàng
