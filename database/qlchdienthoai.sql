...
-- Dumping data for table qlchdienthoai.ctphieunhap: ~33 rows (approximately)
...
-- Dumping data for table qlchdienthoai.ctphieuxuat: ~28 rows (approximately)
...
-- Dumping data for table qlchdienthoai.ctquyen: ~90 rows (approximately)
DELETE FROM `ctquyen`;
...
-- Dumping data for table qlchdienthoai.ctsanpham: ~255 rows (approximately)
...
-- Dumping data for table qlchdienthoai.danhmucchucnang: ~11 rows (approximately)
DELETE FROM `danhmucchucnang`;
...
-- Dumping data for table qlchdienthoai.dungluongram: ~6 rows (approximately)
DELETE FROM `dungluongram`;
...
-- Dumping data for table qlchdienthoai.dungluongrom: ~6 rows (approximately)
DELETE FROM `dungluongrom`;
...
-- Dumping data for table qlchdienthoai.khachhang: ~18 rows (approximately)
DELETE FROM `khachhang`;
INSERT INTO `khachhang` (`makh`, `tenkhachhang`, `diachi`, `sdt`, `trangthai`, `ngaythamgia`) VALUES
	(1, 'Lê Minh Vương', 'Gia Đức, Ân Đức, Hoài Ân, Bình Định', '0387913347', 1, '2024-04-13 09:52:29'),
	(2, 'Thới Thanh Vương', '205 Trần Hưng Đạo, Phường 10, Quận 5, Thành phố Hồ Chí Minh', '0123456789', 1, '2024-04-11 09:52:29'),
	(3, 'Quách Hữu Vinh', 'Khoa Trường, Hoài Ân, Bình Định', '0987654321', 1, '2024-04-09 09:52:29'),
	(4, 'Anh Dany', 'Khoa Trường, Hoài Ân, Bình Định', '0867987456', 1, '2024-04-10 09:52:29'),
	(5, 'Nguyễn Việt Hoàng', '123 Phố Huế, Quận Hai Bà Trưng, Hà Nội', '0935123456', 1, '2024-04-10 09:52:29'),
	(30, 'Trần Đức Minh', '789 Đường Lê Hồng Phong, Thành phố Đà Nẵng', '0983456789', 1, '2024-04-07 09:52:29'),
	(31, 'Lê Hải Yến', '456 Tôn Thất Thuyết, Quận 4, Thành phố Hồ Chí Minh', '0977234567', 1, '2024-03-31 09:52:29'),
	(32, 'Phạm Thanh Hằng', '102 Lê Duẩn, Thành phố Hải Phòng', '0965876543', 1, '2024-04-01 09:52:29'),
	(33, 'Hoàng Đức Anh', '321 Lý Thường Kiệt, Thành phố Cần Thơ', '0946789012', 1, '2024-04-07 09:52:29'),
	(34, 'Ngô Thanh Tùng', '987 Trần Hưng Đạo, Quận 1, Thành phố Hồ Chí Minh', '0912345678', 1, '2024-04-06 09:52:29'),
	(35, 'Võ Thị Kim Ngân', '555 Nguyễn Văn Linh, Quận Nam Từ Liêm, Hà Nội', '0916789123', 1, '2024-04-08 09:52:29'),
	(36, 'Đỗ Văn Tú', '777 Hùng Vương, Thành phố Huế', '0982345678', 1, '2024-04-14 09:52:29'),
	(37, 'Lý Thanh Trúc', '888 Nguyễn Thái Học, Quận Ba Đình, Hà Nội', '0982123456', 1, '2024-04-07 09:52:29'),
	(38, 'Bùi Văn Hoàng', '222 Đường 2/4, Thành phố Nha Trang', '0933789012', 1, '2024-04-03 09:52:29'),
	(39, 'Lê Văn Thành', '23 Đường 3 Tháng 2, Quận 10, TP. Hồ Chí Minh', '0933456789', 1, '2024-04-06 09:52:29'),
	(40, 'Nguyễn Thị Lan Anh', '456 Lê Lợi, Quận 1, TP. Hà Nội', '0965123456', 1, '2024-04-05 09:52:29'),
	(41, 'Phạm Thị Mai', '234 Lê Hồng Phong, Quận 5, TP. Hồ Chí Minh', '0946789012', 1, '2024-04-04 09:52:29'),
...
-- Dumping data for table qlchdienthoai.khuvuckho: ~5 rows (approximately)
DELETE FROM `khuvuckho`;
...
-- Dumping data for table qlchdienthoai.mausac: ~13 rows (approximately)
DELETE FROM `mausac`;
...
-- Dumping data for table qlchdienthoai.nhacungcap: ~7 rows (approximately)
...
-- Dumping data for table qlchdienthoai.nhanvien: ~5 rows (approximately)
DELETE FROM `nhanvien`;
INSERT INTO `nhanvien` (`manv`, `hoten`, `gioitinh`, `ngaysinh`, `sdt`, `email`, `trangthai`) VALUES
	(1, 'Lê Minh Vương', 1, '2004-10-25', '0387913347', 'vuongledz04@gmail.com', 1),
	(2, 'Thới Thanh Vương', 1, '2004-12-19', '0355374322', 'musicanime2501@gmail.com', 1),
	(3, 'Quách Hữu Vinh', 1, '2004-08-11', '0123456789', 'chinchin@gmail.com', 1),
	(4, 'Danh Tiến\r\n', 1, '2003-04-03', '0123456789', 'ngocan@gmail.com', 1),
...
-- Dumping data for table qlchdienthoai.nhomquyen: ~10 rows (approximately)
...
-- Dumping data for table qlchdienthoai.phienbansanpham: ~64 rows (approximately)
...
-- Dumping data for table qlchdienthoai.phieubaohanh: ~0 rows (approximately)
...
-- Dumping data for table qlchdienthoai.phieunhap: ~20 rows (approximately)
...
-- Dumping data for table qlchdienthoai.phieuxuat: ~24 rows (approximately)
...
-- Dumping data for table qlchdienthoai.sanpham: ~16 rows (approximately)
DELETE FROM `sanpham`;
...
-- Dumping data for table qlchdienthoai.xuatxu: ~4 rows (approximately)
DELETE FROM `xuatxu`;
